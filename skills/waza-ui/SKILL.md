...
Pick the path that matches the ask, then read it in full. Building a new surface is the default and starts at [Lock the Direction First](#lock-the-direction-first); it needs neither mode file.
